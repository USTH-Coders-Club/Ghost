...
const messages = {
    ...
    noUserWithEnteredEmailAddr: 'Your credential does not match any accounts on records.',
    accountSuspended: 'Your account was suspended.',
    passwordRequiredForOperation: 'Password is required for this operation',
    incorrectPassword: 'Your credential does not match any accounts on records.',
